...
| `TierStepper` (new) | — | Renders the three fixed tiers, disables anything above the offered limit with an inline reason. Prevents the over-limit hard moment at input rather than rejecting it after submit. |
